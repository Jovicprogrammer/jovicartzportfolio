...
export default function LinksPage() {
    ...
    return (    
        ...
        <div className="flex flex-col bg-cafecomleite h-screen justify-center items-center pt-30">
        ...
        <div>
          <ul className="flex flex-col text-3xl justify-center items-center gap-3 pb-5">
